...
public class DijkstraATodos {
    ...
    private List<List<Integer>> caminoDeCostoMinimoAVertice() {
    ...
    public String toString(int origen) {
        ...
        List<Double> costos = costoMinimoAVertice();
