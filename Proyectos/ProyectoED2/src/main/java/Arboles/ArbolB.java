...
public class ArbolB<K extends Comparable<K>, V> extends ArbolMVias<K, V> {
    ...
    public V eliminar(K claveAEliminar) throws ClaveNoExisteException {
        ...
        int posicionDeLaClaveEnElNodo = super.obtenerPosicionPorDondeBajar(nodoActual, claveAEliminar) - 1;
        V valorAEliminar = nodoActual.getValor(posicionDeLaClaveEnElNodo);
