...
public class AlertSuccess extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        icono.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/success.png"))); // NOI18N

        titulo.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        titulo.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        titulo.setText("SUCCESS");

        mensaje.setFont(new java.awt.Font("Tahoma", 0, 15)); // NOI18N
        mensaje.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        mensaje.setText("Mensaje del error");

        panelRound2.setBackground(new java.awt.Color(0, 102, 0));
        ...
        btn_aceptar.setForeground(new java.awt.Color(0, 102, 0));
        btn_aceptar.setText("ACEPTAR");
        btn_aceptar.setBorderColor(new java.awt.Color(0, 102, 0));
        ...
        panelRound1Layout.setVerticalGroup(
            ...
            .addGroup(panelRound1Layout.createSequentialGroup()
                .addGap(17, 17, 17)
                .addComponent(icono, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE)
