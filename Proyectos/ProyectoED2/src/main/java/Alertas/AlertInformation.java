...
public class AlertInformation extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        icono.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/informacion.png"))); // NOI18N
        ...
        mensaje.setText("Mensaje de la información");
        ...
        btn_aceptar.setForeground(new java.awt.Color(0, 102, 153));
        btn_aceptar.setText("ACEPTAR");
        btn_aceptar.setBorderColor(new java.awt.Color(0, 102, 153));
